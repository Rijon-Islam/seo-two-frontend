...
const PlaceOrder = () => {
  ...
  useEffect(() => {
    fetch(`https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/cash-on-delivery`)
      .then((res) => res.json())
      .then((info) => setCash(info));
  }, []);

  useEffect(() => {
    fetch(`https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/product/${id}`)
      .then((res) => res.json())
  ...
  useEffect(() => {
    fetch(`https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/payment-accounts`)
      .then((res) => res.json())
  ...
  const handlePlaceOrder = (event) => {
    ...
    const url = `https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/new-order`;
    fetch(url, {
      method: "POST",
      headers: {
  ...
  const handlePlaceOrderCashOnDelivery = (event) => {
    ...
    const url = `https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/new-order-cash-on-delivery`;
    fetch(url, {
      method: "POST",
      headers: {
        "content-type": "application/json",
