...
const AddProductVariation = () => {
  ...
  useEffect(() => {
    fetch(`https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/product-variation/${id}`)
      .then((res) => res.json())
  ...
  const handleVariation = (event) => {
    ...
    const url = `https://rjnecommerceseo-88b17f4b1cb1.herokuapp.com/add-variation/${variation._id}`;
    fetch(url, {
      method: 'PUT',
      headers: {
